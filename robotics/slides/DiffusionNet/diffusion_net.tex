...
\begin{figure}
\includegraphics[width=12cm]{./imgs/pick_place.png}
\end{figure}
...
\begin{figure}
\includegraphics[width=3cm]{./imgs/lie.png}
\end{figure}
\begin{itemize}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{./imgs/diffusion_forward.png}
\end{figure}
\begin{itemize}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{./imgs/grasp_diffusion.png}
\end{figure}
\begin{itemize}
...
\begin{figure}
\includegraphics[width=1\linewidth]{./imgs/architecture.png}
\end{figure}
\begin{itemize}
...
\begin{figure}
\includegraphics[width=.8\linewidth]{./imgs/results.png}
\end{figure}
\begin{itemize}
...
\begin{figure}
    \includegraphics[width=8cm]{./imgs/results_grasp_with_motion.png}
\end{figure}
    \begin{itemize}
...
\begin{figure}
    \includegraphics[width=12cm]{./imgs/results_soa.png}
\end{figure}
\begin{itemize}
