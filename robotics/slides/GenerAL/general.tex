...
\begin{figure}
\includegraphics[width=0.5\linewidth]{./imgs/hyper_parameters}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{./imgs/generAL_architecture}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{./imgs/results}
\end{figure}
\end{frame}
