...
\begin{figure}[ht]
    ...
    % X axis -- red
    \draw[axis, red!70!black]
        (0,0) -- (-2.3,-1.5)
        node[below left, black] {$x$};
    ...
    % Elliptical-looking curved arrow around z-axis
    \draw[
        rotation,
        blue!70!black
    ]
    (-0.55,2.45)
        .. controls (-1.15,2.25) and (-0.85,1.85) ..
        (0,1.85)
        .. controls (0.85,1.85) and (1.15,2.25) ..
        (0.55,2.45);
    ...
    (0.55,2.45)
        .. controls (0.45,2.55) and (0.35,2.60) ..
        (0.25,2.60);
    ...
    (2.35,0.65)
        .. controls (1.95,1.10) and (1.75,0.55) ..
        (1.80,0)
        .. controls (1.85,-0.55) and (2.15,-0.80) ..
        (2.45,-0.45);

    \node[green!50!black, font=\large]
        at (2.25,1.05) {Pitch};
    ...
    (-1.75,-0.65)
        .. controls (-2.25,-0.35) and (-2.45,-0.75) ..
        (-2.15,-1.15)
        .. controls (-1.85,-1.55) and (-1.45,-1.35) ..
        (-1.45,-0.95);
    ...
    \caption{Roll, pitch, and yaw rotations about the $x$, $y$, and $z$ axes.}
